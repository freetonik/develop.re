A **hook** is a functionality of software that allows users to have their own [[code]] called under certain circumstances. It's a generic term without a formal definition.
